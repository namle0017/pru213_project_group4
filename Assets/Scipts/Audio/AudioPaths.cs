public static class AudioPaths
{
    ...
    public const string HeadHit = "Audio/Gameplay_SFX/head_hit";
    public const string GameOver = "Audio/Game flow SFX/game_over";

    public const string JackpotUnlock = "Audio/Lucky Spin SFX/jackpot_unlock";
    public const string SpinStart = "Audio/Lucky Spin SFX/spin_start";
    public const string WheelTickLoop = "Audio/Lucky Spin SFX/wheel_tick_loop";
    public const string RewardPopup = "Audio/Lucky Spin SFX/reward_popup";
}
